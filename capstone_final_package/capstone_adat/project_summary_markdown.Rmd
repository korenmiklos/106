...
write.csv(data_clean,'outputs/2018_egyeni_listas_clean.csv')
...
write.csv(by_szavazokor_2018,'outputs/2018_by_szavazokor.csv', fileEncoding = "UTF-8")
...
write.csv(egyeni_lista_by_oevk_2018,'outputs/2018_by_oevk.csv', fileEncoding = "UTF-8")
```
...
write.csv(egyeni_lista_by_telep_2018,'outputs/2018_by_telep.csv', fileEncoding = "UTF-8")
```
...
ggplot(data_OEVK_profil, aes(OEVK_profil, orsz_fidesz_pc)) + geom_point(color ="red") +
  ...
  theme_minimal()
ggsave(("figures/fidesz_vote_oevk_profile.png"), width = 30, height = 18, units = c("cm"))
...
ggplot(data_OEVK_profil, aes(szavazok, orsz_fidesz_pc)) + geom_point(color ="red") +
  ...
  theme_minimal()
ggsave(("figures/fidesz_vote_oevk_size.png"), width = 30, height = 18, units = c("cm"))
...
ggplot(data_OEVK_profil, aes(OEVK_profil, orsz_jobbik_pc)) + geom_point(color ="red") +
  ...
  theme_minimal()
ggsave(("figures/jobbik_vote_oevk_profile.png"), width = 30, height = 18, units = c("cm"))
...
ggplot(data_OEVK_profil, aes(OEVK_profil, orsz_mszp_pc)) + geom_point(color ="red") +
  ...
  theme_minimal()
ggsave(("figures/mszp_vote_oevk_profile.png"), width = 30, height = 18, units = c("cm"))
...
ggplot(data_OEVK_profil, aes(OEVK_profil, orsz_lmp_pc)) + geom_point(color ="red") +
  ...
  theme_minimal()
ggsave(("figures/lmp_vote_oevk_profile.png"), width = 30, height = 18, units = c("cm"))
```
...
write.csv(egyeni_lista_by_telep_2018,'outputs/2018_by_telep_v2.csv', fileEncoding = "UTF-8")
...
ggplot(egyeni_lista_by_telep_2018, aes(telep_tipus, orsz_fidesz_pc)) + geom_point(color ="red") +
  ...
  theme_minimal()
ggsave(("figures/fidesz_vote_town_size.png"), width = 30, height = 18, units = c("cm"))
...
ggplot(egyeni_lista_by_telep_2018, aes(telep_tipus, orsz_mszp_pc)) + geom_point(color ="red") +
  ...
  theme_minimal()
ggsave(("figures/mszp_vote_town_size.png"), width = 30, height = 18, units = c("cm"))
...
ggplot(egyeni_lista_by_telep_2018, aes(telep_tipus, orsz_jobbik_pc)) +
 geom_smooth(method = "loess") +  geom_point(color ="red") + ggtitle("Jobbik vote share % by town size") + xlab("Town size category") + ylab("Jobbik vote share") +
  theme_minimal()
ggsave(("figures/jobbik_vote_town_size.png"), width = 30, height = 18, units = c("cm"))
...
ggplot(egyeni_lista_by_telep_2018, aes(telep_tipus, orsz_lmp_pc)) + geom_point(color ="red") +
  ...
  theme_minimal()
ggsave(("figures/lmp_vote_town_size.png"), width = 30, height = 18, units = c("cm"))
...
ggplot(OEVK_pred_elemzes, aes(Fidesz_egyeni_becsles, egyeni_fidesz_pc)) + geom_point(color ="red") +
  ...
  ylim(0.25, 0.65) +
  theme_minimal()
ggsave(("figures/fidesz_pred_actual.png"), width = 25, height = 25, units = c("cm"))
...
ggplot(OEVK_pred_elemzes, aes(egyeni_fidesz_pc, Fidesz_pred_elteres)) + geom_point(color ="red") +
  ...
  xlim(0.25, 0.65) +
theme_minimal()
ggsave(("figures/fidesz_deviation.png"), width = 25, height = 25, units = c("cm"))
...
ggplot(OEVK_pred_elemzes, aes(Jobbik_egyeni_becsles, egyeni_jobbik_pc)) + geom_point(color ="red") +
  ...
  ylim(0.00, 0.50) +
  theme_minimal()
ggsave(("figures/jobbik_pred_actual.png"), width = 25, height = 25, units = c("cm"))
...
ggplot(OEVK_pred_elemzes, aes(egyeni_jobbik_pc, Jobbik_pred_elteres)) + geom_point(color ="red") +
  ...
  xlim(0.05, 0.45) +
theme_minimal()
ggsave(("figures/jobbik_deviation.png"), width = 25, height = 25, units = c("cm"))
...
ggplot(OEVK_pred_elemzes, aes(Baloldal_egyeni_becsles, egyeni_dk_pc)) + geom_point(color ="red") +
  ...
  ylim(0.001, 0.55) +
theme_minimal()
ggsave(("figures/dk_pred_actual.png"), width = 25, height = 25, units = c("cm"))
...
ggplot(OEVK_pred_elemzes, aes(egyeni_dk_pc, Baloldal_pred_elteres)) + geom_point(color ="red") +
  ...
  xlim(0.001, 0.55) +
  theme_minimal()
  ggsave(("figures/dk_deviation.png"), width = 25, height = 25, units = c("cm"))
  ...
  ggplot(OEVK_pred_elemzes, aes(Baloldal_egyeni_becsles, egyeni_mszp_pc)) + geom_point(color ="red") +
    ...
    ylim(0.001, 0.60) +
  theme_minimal()
  ggsave(("figures/mszp_pred_actual.png"), width = 25, height = 25, units = c("cm"))
  ...
  ggplot(OEVK_pred_elemzes, aes(egyeni_mszp_pc, Baloldal_pred_elteres)) + geom_point(color ="red") +
    ...
    xlim(0.001, 0.60) +
  theme_minimal()
  ggsave(("figures/mszp_deviation.png"), width = 25, height = 25, units = c("cm"))
  ...
  ggplot(OEVK_pred_elemzes, aes(LMP_egyeni_becsles, egyeni_lmp_pc)) + geom_point(color ="red") +
    ...
    ylim(0.08, 0.55) +
  theme_minimal()
  ggsave(("figures/lmp_pred_actual.png"), width = 25, height = 25, units = c("cm"))
  ...
  ggplot(OEVK_pred_elemzes, aes(egyeni_lmp_pc, LMP_pred_elteres)) + geom_point(color ="red") +
    ...
    xlim(0.08, 0.55) +
  theme_minimal()
  ggsave(("figures/lmp_deviation.png"), width = 25, height = 25, units = c("cm"))
```
...
```{r warning=FALSE}
 data_telepulesadatok_t_star <-read.csv("Telepulesadatok_t_star.csv")
  ...
  write.csv(t_star_telepules_2014_2018, 'outputs/2014_2018_tstar_by_telep.csv')
  ...
  ggplot(data = t_star_telepules_2014_2018, aes(x=egyeni_fidesz_pc.y, y= pred_logit_fidesz)) + xlim(0.15, 1.00) + ylim(0.15, 1.00) +
    ...
    theme_minimal() 
    ggsave(("figures/fidesz_GLM_by_megye_id.png"), width = 25, height = 25, units = c("cm"))
    ...
    ggplot(data = t_star_telepules_2014_2018, aes(x=egyeni_fidesz_pc.y, y= pred_logit_fidesz)) + xlim(0.15, 1.00) + ylim(0.15, 1.00) +
      ...
      geom_line(aes(x=pred_logit_fidesz, y=pred_logit_fidesz), color="green", size = 1) +
    theme_minimal() 
    ggsave(("figures/fidesz_GLM_by_town.png"), width = 25, height = 25, units = c("cm"))
...
### Jobbik
    ...
    theme_minimal() 
    ggsave(("figures/Jobbik_GLM_by_megye_id.png"), width = 25, height = 25, units = c("cm"))
    ...
    ggplot(data = t_star_telepules_2014_2018, aes(x=egyeni_jobbik_pc.y, y= pred_logit_jobbik)) + xlim(0.00, 0.65) + ylim(0.00, 0.65) +
      ...
      geom_line(aes(x=pred_logit_jobbik, y=pred_logit_jobbik), color="green", size = 1) +
    theme_minimal() 
    ggsave(("figures/Jobbik_GLM_by_town.png"), width = 25, height = 25, units = c("cm"))
...
```{r warning=FALSE}
  ...
  write.csv(merge_all_t_star_all, 'outputs/2014_2018_tstar_all_by_telep.csv')
  ...
  ggplot(data = merge_all_t_star_all, aes(x=egyeni_fidesz_pc.y, y= pred_logit_fidesz)) + xlim(0.15, 1.00) + ylim(0.15, 1.00) +
    ...
    geom_line(aes(x=pred_logit_fidesz, y=pred_logit_fidesz), color="green", size = 1) +
  theme_minimal() 
  ggsave(("figures/fidesz_GLM_by_megye_id_2.png"), width = 25, height = 25, units = c("cm"))
  ...
  ggplot(data = merge_all_t_star_all, aes(x=egyeni_fidesz_pc.y, y= pred_logit_fidesz)) + xlim(0.15, 1.00) + ylim(0.15, 1.00) +
    ...
    geom_line(aes(x=pred_logit_fidesz, y=pred_logit_fidesz), color="green", size = 1) +
  theme_minimal() 
  ggsave(("figures/fidesz_GLM_by_town_2.png"), width = 25, height = 25, units = c("cm"))
  ...
  ggplot(data = merge_all_t_star_all, aes(x=egyeni_jobbik_pc.y, y= pred_logit_jobbik)) + xlim(0.00, 0.65) + ylim(0.00, 0.65) +
    ...
    geom_line(aes(x=pred_logit_jobbik, y=pred_logit_jobbik), color="green", size = 1) +
    theme_minimal() 
  ggsave(("figures/Jobbik_GLM_by_megye_id_2.png"), width = 25, height = 25, units = c("cm"))
  ...
  ggplot(data = merge_all_t_star_all, aes(x=egyeni_jobbik_pc.y, y= pred_logit_jobbik)) + xlim(0.00, 0.65) + ylim(0.00, 0.65) +
    ...
    geom_line(aes(x=pred_logit_jobbik, y=pred_logit_jobbik), color="green", size = 1) +
    theme_minimal() 
  ggsave(("figures/Jobbik_GLM_by_town_2.png"), width = 25, height = 25, units = c("cm"))
...
```{r warning=FALSE}
 new_by_oevk_2014 <- read.csv("oevk2014_clean_new.csv")
  ...
  write.csv(oevk_2014_vs_2018, "outputs/egyeni_oevk_2014_vs_2018.csv")
...
oevk_2014_vs_2018_glm_fidesz <- glm(egyeni_fidesz_pc.y ~ egyeni_fidesz_pc.x + szavazokorok_szama + telepulesek_szama + profil + varos_aranya, data=oevk_2014_vs_2018)
  ...
  ggplot(data = oevk_2014_vs_2018, aes(x=egyeni_fidesz_pc.y, y= pred_logit_fidesz)) + xlim(0.25, 0.65) + ylim(0.25, 0.65) +
    ...
    geom_line(aes(x=pred_logit_fidesz, y=pred_logit_fidesz), color="green", size = 1) +
    theme_minimal() 
  ggsave(("figures/fidesz_GLM_by_OEVK.png"), width = 25, height = 25, units = c("cm"))
   ...
   ggplot(data = oevk_2014_vs_2018, aes(x=egyeni_fidesz_pc.y, y= pred_logit_fidesz)) + xlim(0.25, 0.65) + ylim(0.25, 0.65) +
    ...
    geom_line(aes(x=pred_logit_fidesz, y=pred_logit_fidesz), color="green", size = 1) +
    theme_minimal() 
  ggsave(("figures/fidesz_GLM_by_OEVK_2.png"), width = 25, height = 25, units = c("cm"))
...
oevk_2014_vs_2018_glm_jobbik <- glm(egyeni_jobbik_pc.y ~ egyeni_jobbik_pc.x + szavazokorok_szama + telepulesek_szama + profil + varos_aranya, data=oevk_2014_vs_2018)
  ...
  ggplot(data = oevk_2014_vs_2018, aes(x=egyeni_jobbik_pc.y, y= pred_logit_jobbik)) + xlim(0.00, 0.5) + ylim(0.00, 0.5) +
    ...
    geom_line(aes(x=pred_logit_jobbik, y=pred_logit_jobbik), color="green", size = 1) +
    theme_minimal() 
  ggsave(("figures/jobbik_GLM_by_OEVK.png"), width = 25, height = 25, units = c("cm"))
   ...
   ggplot(data = oevk_2014_vs_2018, aes(x=egyeni_jobbik_pc.y, y= pred_logit_jobbik)) + xlim(0.00, 0.5) + ylim(0.00, 0.5) +
    ...
    geom_line(aes(x=pred_logit_jobbik, y=pred_logit_jobbik), color="green", size = 1) +
    theme_minimal() 
  ggsave(("figures/jobbik_GLM_by_OEVK_2.png"), width = 25, height = 25, units = c("cm"))
...
oevk_2014_vs_2018_glm_mszp <- glm(egyeni_mszp_pc ~ egyeni_kormanyvaltok_pc + szavazokorok_szama + telepulesek_szama + profil + varos_aranya, data=oevk_2014_vs_2018)
  ...
  ggplot(data = oevk_2014_vs_2018, aes(x=egyeni_mszp_pc, y= pred_logit_mszp)) + xlim(0.001, 0.65) + ylim(0.001, 0.65) +
    ...
    theme_minimal() 
  ggsave(("figures/mszp_GLM_by_OEVK.png"), width = 25, height = 25, units = c("cm"))
...
#LMP 
  ...
  ggplot(data = oevk_2014_vs_2018, aes(x=egyeni_lmp_pc.y, y= pred_logit_lmp)) + xlim(0.001, 0.2) + ylim(0.001, 0.2) +
    ...
    theme_minimal() 
  ggsave(("figures/lmp_GLM_by_OEVK.png"), width = 25, height = 25, units = c("cm"))
```
...
write.csv(oevk_2014_vs_2018, "outputs/oevk_2014_2018_UNS_OEVK_values.csv")  
  ...
  ggplot(data = oevk_2014_vs_2018, aes(x=egyeni_fidesz_pc.y, y= Fidesz_2018_UNS_egyeni_pc)) + xlim(0.25, 0.65) + ylim(0.25, 0.65) +
    ...
    theme_minimal() 
  ggsave(("figures/fidesz_UNS_by_OEVK.png"), width = 25, height = 25, units = c("cm"))
  ...
  ggplot(data = oevk_2014_vs_2018, aes(x=egyeni_fidesz_pc.y, y= Fidesz_2018_UNS_egyeni_pc)) + xlim(0.25, 0.65) + ylim(0.25, 0.65) +
    ...
    geom_line(aes(x=Fidesz_2018_UNS_egyeni_pc, y=Fidesz_2018_UNS_egyeni_pc), color="green", size = 1) +
    theme_minimal() 
  ggsave(("figures/fidesz_UNS_by_OEVK_type.png"), width = 25, height = 25, units = c("cm"))
  ...
  #JOBBIK
   ...
   ggplot(data = oevk_2014_vs_2018, aes(x=egyeni_jobbik_pc.y, y= Jobbik_2018_UNS_egyeni_pc)) + xlim(0.05, 0.45) + ylim(0.05, 0.45) +
    ...
    theme_minimal() 
  ggsave(("figures/Jobbik_UNS_by_OEVK.png"), width = 25, height = 25, units = c("cm"))
  ...
  ggplot(data = oevk_2014_vs_2018, aes(x=egyeni_jobbik_pc.y, y= Jobbik_2018_UNS_egyeni_pc)) + xlim(0.05, 0.45) + ylim(0.05, 0.45) +
    ...
    geom_line(aes(x=Jobbik_2018_UNS_egyeni_pc, y=Jobbik_2018_UNS_egyeni_pc), color="green", size = 1) +
    theme_minimal() 
  ggsave(("figures/Jobbik_UNS_by_OEVK_type.png"), width = 25, height = 25, units = c("cm"))
  ...
  #MSZP-DK
   ...
   ggplot(data = oevk_2014_vs_2018, aes(x=egyeni_mszp_pc, y= MSZP_DK_2018_UNS_egyeni_pc)) + xlim(0.001, 0.6) + ylim(0.001, 0.6) +
    ...
    theme_minimal() 
  ggsave(("figures/MSZP_UNS_by_OEVK.png"), width = 25, height = 25, units = c("cm"))
  ...
  ggplot(data = oevk_2014_vs_2018, aes(x=egyeni_mszp_pc, y= MSZP_DK_2018_UNS_egyeni_pc)) + xlim(0.001, 0.6) + ylim(0.001, 0.6) +
    ...
    geom_line(aes(x=MSZP_DK_2018_UNS_egyeni_pc, y=MSZP_DK_2018_UNS_egyeni_pc), color="green", size = 1) +
    theme_minimal() 
  ggsave(("figures/MSZP_UNS_by_OEVK_type.png"), width = 25, height = 25, units = c("cm"))
  ...
  ggplot(data = oevk_2014_vs_2018, aes(x=egyeni_lmp_pc.y, y= LMP_2018_UNS_egyeni_pc)) + xlim(0.001, 0.3) + ylim(0.001, 0.3) +
    ...
    theme_minimal() 
  ggsave(("figures/LMP_UNS_by_OEVK.png"), width = 25, height = 25, units = c("cm"))
  ...
  ggplot(data = oevk_2014_vs_2018, aes(x=egyeni_lmp_pc.y, y= MSZP_DK_2018_UNS_egyeni_pc)) + xlim(0.001, 0.3) + ylim(0.001, 0.3) +
    ...
    geom_line(aes(x=LMP_2018_UNS_egyeni_pc, y=LMP_2018_UNS_egyeni_pc), color="green", size = 1) +
    theme_minimal() 
  ggsave(("figures/LMP_UNS_by_OEVK_type.png"), width = 25, height = 25, units = c("cm"))  
...
### UNS deviation   
  ...
  ggplot(oevk_2014_vs_2018, aes(egyeni_fidesz_pc.y, Fidesz_2018_UNS_egyeni_pc_elteres)) + geom_point(color ="red") +
    ...
    xlim(0.25, 0.65) +
    theme_minimal()
  ggsave(("figures/fidesz_UNS_deviation_by_OEVK.png"), width = 25, height = 25, units = c("cm"))
  ...
  ggplot(oevk_2014_vs_2018, aes(egyeni_jobbik_pc.y, Jobbik_2018_UNS_egyeni_pc_elteres)) + geom_point(color ="red") +
    ...
    xlim(0.05, 0.45) +
    theme_minimal()
  ggsave(("figures/jobbik_UNS_deviation_by_OEVK.png"), width = 25, height = 25, units = c("cm"))
  ...
  ggplot(oevk_2014_vs_2018, aes(egyeni_mszp_pc, MSZP_DK_2018_UNS_egyeni_pc_elteres)) + geom_point(color ="red") +
    ...
    xlim(0.001, 0.6) +
    theme_minimal()
  ggsave(("figures/mszp_UNS_deviation_by_OEVK.png"), width = 25, height = 25, units = c("cm"))
  ...
  ggplot(oevk_2014_vs_2018, aes(egyeni_lmp_pc.y, LMP_2018_UNS_egyeni_pc_elteres)) + geom_point(color ="red") +
    ...
    geom_hline (yintercept=0, linetype="dashed", color = "red") +
    ggtitle("LMP actual vote share and prediction error by OEVK") +
    xlab("LMP vote share") + ylab("UNS Prediction error") +
    xlim(0.001, 0.25) +
    theme_minimal()
  ggsave(("figures/LMP_UNS_deviation_by_OEVK.png"), width = 25, height = 25, units = c("cm"))
...
setwd('C:/Users/adasan01/OneDrive - ARM/Documents/GitHub/106/capstone_adat')
  ...
  write.csv(by_oevk_UNS_2018,'outputs/2018_UNS_baseline.csv')
```